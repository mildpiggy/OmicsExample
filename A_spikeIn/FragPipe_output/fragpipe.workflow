...
database.db-path=F\:\\FASTA\\FragPipe_fasta\\human_ecoliK12_S.cervisiae.fasta
...
fragpipe-config.bin-ionquant=F\:\\fragpipe\\tools\\IonQuant-1.8.10.jar
fragpipe-config.bin-msfragger=F\:\\fragpipe\\tools\\MSFragger-3.7\\MSFragger-3.7.jar
fragpipe-config.bin-philosopher=F\:\\fragpipe\\tools\\philosopher_v4.8.1_windows_amd64\\philosopher.exe
fragpipe-config.bin-python=F\:\\anaconda3\\python.exe
freequant.mz-tol=10
